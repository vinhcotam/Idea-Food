...
//                FirebaseDatabase.getInstance().getReference().child("tags").push().setValue(tag);
                if(imgUri!=null||img1Uri!=null||videoUri!=null||content1!=null
                    ...
                    Toast.makeText(createpost2.this,"Vui lòng nhập đầu đủ thông tin",Toast.LENGTH_LONG).show();
                }
...
//                    FirebaseDatabase.getInstance().getReference().child("images").push().setValue(img);
                    ...
                    Toast.makeText(createpost2.this,"Bài đăng của bạn đang đợi được duyệt",Toast.LENGTH_LONG).show();
    ...
    private void requestPermissions() {
        PermissionListener permissionlistener = new PermissionListener() {
            ...
            public void onPermissionGranted() {
                Toast.makeText(createpost2.this, "Yêu cầu thành công", Toast.LENGTH_SHORT).show();

            }

            @Override
            public void onPermissionDenied(List<String> deniedPermissions) {
                Toast.makeText(createpost2.this, "Yêu cầu bị từ chối\n" + deniedPermissions.toString(), Toast.LENGTH_SHORT).show();
            }
